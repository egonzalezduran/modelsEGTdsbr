...
M1 <-glm(FGT ~ 0 + Genotype + SELt:Genotype , weights= sqrt(TOTev), data = FGT1df, family = gaussian, contrasts= list(Genotype=contr.treatment(c("lig41p","polqpol1","pRB98"),base=3)))
confint(M1)
summary(M1)
